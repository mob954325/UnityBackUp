...
public class Player : MonoBehaviour
{
    ...
    private int Life
    {
        ...
        set
        {
            ...
            life = Mathf.Clamp(life, 0, 3); // 항상 0-3
   ...
   //}
    ...
    void OnHit()
    {
        //Debug.Log($"플레이어어의 생명력이 {life}남았다.");
    ...
    {
        gameObject.layer = LayerMask.NameToLayer("InvinciblePlayer"); // 무적 레이어로 변경
        ...
        while (timeElapsed < invincibleTime)
        {
            ...
            sprite.color = new Color(1, 1, 1, alpha); // 알파로 지정 -> 깜빡거린다.
        ...
        sprite.color = Color.white; // 알파값도 원상복구
    }

    void OnDie()
    {
        Debug.Log($"플레이어어가 죽었다.");
        // 충돌 x
        ...
        // 튕겨 나가는 듯한 연출
        rigid2d.gravityScale = 1.0f; // 중력활성화
